...
import {setInputMessage, setIsFullScreen, setIsModalShown} from "../store/mainInfo.slice";
...
export function SupportChat() {
    ...
    let fullScreenClassName: string = mainInfo?.isFullScreen ? "bottom-0 right-0 max-h-[580px] max-w-[470px] " : "left-0 top-0 ";

    useEffect(() => {
        fullScreenClassName = mainInfo?.isFullScreen ? "bottom-0 right-0 max-h-[580px] max-w-[470px] " : "left-0 top-0 "
        return () => {
           ...
           <div className="flex w-full h-full shadow-[0_0_10px_rgba(0,0,0,0.2)] bg-white">
                <div className="h-[100%] w-[90px] bg-[#f1f3fa] shadow-[1px_0_1px_rgba(0,0,0,0.12)]">
                    <div className="flex pb-[16px] flex-col justify-between h-[100%]">
                        ...
                        <a className="m-0 block text-center decoration-0">
                   ...
                   <div className="flex flex-1 flex-col h-[320px] items-center justify-center">
                       <div className="flex h-full w-full flex-col justify-start p-[8px]">
                            <div className="flex-1 w-full overflow-auto">
                                <div className="flex flex-row p-[16px] min-h-[200px] items-center">
